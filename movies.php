...
if (!$conn) {
    ...
    $watchInsert = "INSERT INTO watchlist (MovieID, Name, BoxOffice, Release_date, Production_cost) SELECT MovieID, Name, BoxOffice, Release_date, Production_cost FROM movies WHERE MovieID = $x";
